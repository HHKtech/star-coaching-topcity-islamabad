...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-24 right-6 z-50 w-12 h-12 rounded-full bg-[var(--surface)] border border-[var(--border)] shadow-lg flex items-center justify-center text-[var(--text)] hover:scale-110 hover:shadow-xl transition-all duration-300 group"
